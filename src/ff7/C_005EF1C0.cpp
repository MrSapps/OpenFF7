...
////////////////////////////////////////
struct t_coaster_Node D_00C5D360[0xa];//RIGHT
...
struct t_coaster_Node D_00C60320[0xa];//LEFT
////////////////////////////////////////
void C_005EF281(struct t_coaster_Node *, short);//init top node

//init this module
void C_005EF1C0() {
	int i;//local_1

	C_005EF281(&D_00C60150, 0);//init top node
	D_00C60150.wDepth = 0;
	D_00C60188 = 0;
	for(i = 0; i < 0xc8; i ++)
		D_00C60190[i] = i + 1;
...
//allocate "Node"
struct t_coaster_Node *C_005EF31E(short wModelId/*bp08*/, struct t_coaster_Node *pParentNode/*bp0c*/, int x/*bp10*/, int y/*bp14*/, int z/*bp18*/, short alpha/*bp1c*/, short beta/*bp20*/, short gamma/*bp24*/) {
	struct {
	...
	//-- rotate --
	lolo.sRot.f_00 = alpha;
	lolo.sRot.f_02 = beta;
	lolo.sRot.f_04 = gamma;
	C_00662CD2(&lolo.sRot, &(lolo.pNode->f_04));//psx:xyz_rotate(3)
	//-- translate --
	lolo.pNode->f_04.f_12[0] = x;
	lolo.pNode->f_04.f_12[1] = y;
	lolo.pNode->f_04.f_12[2] = z;
