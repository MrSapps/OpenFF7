...
//<moved>:int D_00C3F6F8 = D_0090147C * 0x20;
struct t_sound_related_24 D_00C3F700;
short D_00C3F724;//blink counter for "last shoot score"
struct SVECTOR D_00C3F728;
char D_00C3F730;
class psxdata_c D_00C3F738;
/*<moved>:*/int D_00C3F6F8 = D_0090147C * 0x20;//moved because its initializers are after D_00C3F738's
...
void C_005E9319() {
	...
	C_00675511("coaster.lgp", 9);//is_lib:open archive?
	D_00C3F738.C_005EE620("xbinadr.bin", "xbin.bin");
	//%%% cache sounds? %%%%
	for(i = 0x16; i >= 0; i --)
